...
class OrderViewSet(viewsets.ModelViewSet):
    ...
    def list(self, request):
        ...
        if 'type' in request.query_params and request.query_params['type'] == 'my_orders' :
    ...
    def create(self, request):
        ...
        if serializer.is_valid():
            ...
            if serializer.validated_data['orderer'] == serializer.validated_data['receiver']:
                return Response({'detail':'you can not order yourself'}, status=status.HTTP_400_BAD_REQUEST)
